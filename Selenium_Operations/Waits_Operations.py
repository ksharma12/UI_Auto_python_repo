...
class Waits_Operations(Common_Operations):
    ...
    def wait_until_element_clickable(self, locator):
        try:
            ...
            element = wait.until(
                EC.element_to_be_clickable((self.get_locator_signature(locator), self.get_locator_values(locator))))
    ...
    def wait_until_element_present(self, locator):
        try:
            ...
            element_present = wait.until(
                EC.presence_of_element_located((self.get_locator_signature(locator), self.get_locator_values(locator))))
